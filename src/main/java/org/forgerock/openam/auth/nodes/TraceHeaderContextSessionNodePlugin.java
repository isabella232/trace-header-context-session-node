...
public class TraceHeaderContextSessionNodePlugin extends AbstractNodeAmPlugin {
	...
	protected Map<String, Iterable<? extends Class<? extends Node>>> getNodesByVersion() {
		return Collections.singletonMap(TraceHeaderContextSessionNodePlugin.currentVersion,
				Collections.singletonList(TraceHeaderContextSessionNode.class));
	}
	...
	public String getPluginVersion() {
		return TraceHeaderContextSessionNodePlugin.currentVersion;
	}
}
